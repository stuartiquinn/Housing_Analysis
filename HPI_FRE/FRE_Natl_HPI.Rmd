...
##Install Packages
```{r, packageInstall, echo = T, message = F, warning = F, eval = T}
###################Packages#####################
if(!require(dplyr)){
...
##Load Data Frame
```{r, dataLoad, echo = T, eval = T, warning = F, message = F}
#######################Data Clean + Load ###############################
...
```{r,featureEngineer, eval = T, echo = T, warning = F, message = F}
...
```{r, plotParamsAxes, echo = T, warning = F, eval = T, message = F}
##############################################Plots################################
...
##Plot
```{r plotNatl, echo = T, eval = T, message = F, warning = F, fig.align = 'center', fig.width = 15, fig.height = 11}
